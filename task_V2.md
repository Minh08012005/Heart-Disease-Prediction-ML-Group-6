...
│
├── GIAI ĐOẠN 1: CHUẨN BỊ (Cell 1 → 4)
│   ├── Cell 1: Tiêu đề + Giới thiệu
│   ├── Cell 2: Import thư viện
│   ├── Cell 3: Load dữ liệu
│   └── Cell 4: FEATURE SELECTION (chọn features quan trọng)
│
├── GIAI ĐOẠN 2: TRAIN CƠ BẢN (Cell 5 → 6)
│   ├── Cell 5: Train Custom DT (max_depth=5)
│   └── Cell 6: Đánh giá kết quả
│
├── GIAI ĐOẠN 3: GIẢI THÍCH (Cell 7)
│   └── Cell 7: Giải thích ý nghĩa các metrics
│
├── GIAI ĐOẠN 4: HYPERPARAMETER TUNING (Cell 8 → 9)
│   ├── Cell 8: Tuning tham số
│   └── Cell 9: Vẽ biểu đồ tuning
│
└── GIAI ĐOẠN 5: SO SÁNH VỚI SKLEARN (Cell 10 → 11)
    ├── Cell 10: So sánh với sklearn
    └── Cell 11: Nhận xét & Kết luận
```
...
#### GIAI ĐOẠN 1: CHUẨN BỊ & FEATURE SELECTION (Cell 1 → 4)

**Mục tiêu:** Thiết lập môi trường làm việc, load dữ liệu, và chọn features quan trọng.
...
**Cell 5 - Train Custom Decision Tree:**
...
**Cell 11 - Nhận xét & Kết luận (Markdown):**
